...
/**
 * Class OauthAuthorizationCodesModelTest
 * @package UserModuleTest\Model
 */
class OauthAuthorizationCodesModelTest extends AbstractApplicationTestCase
{
    ...
    {
        $modelName = new OauthAuthorizationCodesModel();
    ...
    {
        return [
            ["authorizationCode", self::DEFAULT_TESTING_VALUE,],
            ...
            ["idToken", self::DEFAULT_TESTING_VALUE,],
        ];
    }
