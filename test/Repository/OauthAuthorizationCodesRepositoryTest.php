...
/**
 * Class OauthAuthorizationCodesRepositoryTest
 * @package UserModuleTest\Repository
 */
class OauthAuthorizationCodesRepositoryTest extends AbstractApplicationTestCase
{
    /** @var string DEFAULT_TESTING_VALUE */
    public const DEFAULT_TESTING_VALUE = "Test";

    /** @var OauthAuthorizationCodesModel $oauthAuthorizationCodesModelMock */
    protected $oauthAuthorizationCodesModelMock;
    ...
    /** @var OauthAuthorizationCodesRepository $oauthAuthorizationCodesRepository */
    protected $oauthAuthorizationCodesRepository;
    ...
    public function setUp(): void
    {
        ...
        $this->adapterMock = $this->getMockBuilder(Adapter::class)
            ...
            ->getMock();
        $this->oauthAuthorizationCodesModelMock = $this->getMockBuilder(OauthAuthorizationCodesModel::class)
            ->disableOriginalConstructor()
            ->getMock();
        ...
        $this->container->setService(OauthAuthorizationCodesModel::class, $this->oauthAuthorizationCodesModelMock);
        ...
        $this->oauthAuthorizationCodesRepository = $this->container->get("ServiceManager")
            ->get(OauthAuthorizationCodesRepository::class);
        $this->oauthAuthorizationCodesRepository->setDbAdapter($this->adapterMock);
        $this->oauthAuthorizationCodesRepository->setSql($this->sqlMock);
    }
     ...
     */
    public function testFindOauthAuthorizationCodesByClientIdReturnsNull()
    {
        $this->oauthAuthorizationCodesModelMock->method("exchangeArray")
            ->willReturnSelf();

        $this->assertNull(
            $this->oauthAuthorizationCodesRepository->findOauthAuthorizationCodesByClientId(self::DEFAULT_TESTING_VALUE)
        );
    }
     ...
     * @throws \SebastianBergmann\RecursionContext\InvalidArgumentException
     */
    public function testFindOauthAuthorizationCodesByUserIdAndClientIdReturnsNull()
    {
        $this->oauthAuthorizationCodesModelMock->method("exchangeArray")
            ->willReturnSelf();

        $this->assertNull(
            $this->oauthAuthorizationCodesRepository->findOauthAuthorizationCodesByUserIdAndClientId(
     ...
     * @throws \SebastianBergmann\RecursionContext\InvalidArgumentException
     */
    public function testFindOauthAuthorizationCodesByAuthorizationCodeReturnsNull()
    {
        $this->oauthAuthorizationCodesModelMock->method("exchangeArray")
            ->willReturnSelf();

        $this->assertNull(
            $this->oauthAuthorizationCodesRepository->findOauthAuthorizationCodesByAuthorizationCode(
                self::DEFAULT_TESTING_VALUE
            )
        );
    }
    ...
    {
        $this->assertIsBool(
            $this->oauthAuthorizationCodesRepository->upsert(
                [
                    "authorization_code" => self::DEFAULT_TESTING_VALUE,
                    "client_id" => self::DEFAULT_TESTING_VALUE,
                    "user_id" => self::DEFAULT_TESTING_VALUE,
                    "redirect_uri" => self::DEFAULT_TESTING_VALUE,
